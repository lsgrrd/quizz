      ...
      respuesta1(x) {
        ...
        if (this.next < 5) {
          ...
          if(this.uno > this.dos && this.uno > this.tres ){
            this.ganador = 'Eres toda una Lourdes Tibán' ;
            this.imgGanador = '/imgs/16.jpeg'
          }
          if(this.dos > this.uno && this.dos > this.tres ){
            this.ganador = 'Eres toda una Cynthia Viteri' ;
            this.imgGanador = '/imgs/9.jpeg';
          }
          if(this.tres > this.uno && this.tres > this.dos ){
            this.ganador = 'Eres toda una Elsa Bucaram' ;
            this.imgGanador = '/imgs/4.jpeg';
          }
